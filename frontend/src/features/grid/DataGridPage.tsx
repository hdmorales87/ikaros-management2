...
type GridConfig = { table: string; title: string; description: string; columns: string[]; filters?: Record<string, unknown>; searchFields?: string[] }
